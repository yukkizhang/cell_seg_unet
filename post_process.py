...
def postprocess(image_path):
    ...
    # to do: do the black/white binary in the file folder instead of image
    # convert the image type and pixel value into right interval
    # imgMax = img.max()
    # imgMin = img.min()
    # medium = (imgMax - imgMin) / 2
    ...
    #         else:
    #             img[i][j] = 0
    # io.imsave(r'D:\2PM_2023\segmentation\test_accuracy\prediction/new_2.png',img)
    # print(img)
...
if __name__ == '__main__':
    ...
    # prediction_path = r'D:\2PM_2023\segmentation\test_accuracy\prediction/2.png'
    # mask_path = r'D:\2PM_2023\segmentation\test_accuracy\label/0.png'

    # print(postprocess(prediction_path))
